...
# classes = ['earth_person', 'sea_person']

classes = ['rubbish']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='UAVVaste-yolo/images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='UAVVaste-yolo/labels/test',type=str, help="path of labels .txt")
parser.add_argument('--save_path', type=str,default='data_UAVVaste.json', help="if not split the dataset, give a path to a json file")
