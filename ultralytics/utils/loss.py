...
class v8DetectionLoss:
    ...
    def __init__(self, model):  # model must be de-paralleled
        ...
        self.assigner = TaskAlignedAssigner(topk=15, num_classes=self.nc, alpha=0.5, beta=5.0)
...
class v8SegmentationLoss(v8DetectionLoss):
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR 鉂?segment dataset incorrectly formatted or not a segment dataset.\n'
