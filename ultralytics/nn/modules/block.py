...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3k', 'C3k2', 'C2PSA',
           'C3x', 'C3TR', 'C3Ghost',
...
class C3k(C3):
    """C3 module with configurable bottleneck kernel size."""
...
class C3k2(C2f):
    """C2f block that optionally uses C3k bottlenecks."""
...
class Attention(nn.Module):
    """Area attention used by newer Ultralytics YOLO blocks."""
    ...
    def forward(self, x):
        """Apply attention to BCHW feature maps."""
        b, c, h, w = x.shape
        n = h * w
        qkv = self.qkv(x)
...
class C2PSA(nn.Module):
    """C2 block with position-sensitive attention."""
